...
export const FolderIcon = ({ className = "" }: IconProps) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M3 7h18M3 7l3-3h12l3 3M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7"
    />
  </svg>
);
...
export const YouTubeIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M21.8 8s-.2-1.6-.8-2.3c-.8-.9-1.7-.9-2.1-.9C15.2 4.8 12 4.8 12 4.8h-.1s-3.2 0-6.9.1c-.4 0-1.3 0-2.1.9-.6.7-.8 2.3-.8 2.3S2 9.6 2 11.2v1.6c0 1.6.2 3.2.2 3.2s.2 1.6.8 2.3c.8.9 1.8.9 2.3.9 1.6.1 6.7.1 6.7.1s3.2 0 6.9-.1c.4 0 1.3 0 2.1-.9.6-.7.8-2.3.8-2.3s.2-1.6.2-3.2v-1.6c0-1.6-.2-3.2-.2-3.2zM9.5 14.5V9.5l5 2.5-5 2.5z" />
  </svg>
);
...
export const CheckIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="currentColor"
    className={`w-[18px] h-[18px] inline shrink-0 opacity-80 ${className}`}
  >
    <path
      fillRule="evenodd"
...
export const FireIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className={`w-6 h-6 stroke-orange-600 ${className}`}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const GiftIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className={`w-6 h-6 stroke-yellow-600 ${className}`}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const AcademicCapIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className={`w-6 h-6 stroke-green-600 ${className}`}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ChevronUpIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`w-5 h-5 ease-in-out duration-150 -translate-y-0.5 group-hover:translate-y-0 ${className}`}
  >
...
export const CrossIcon = ({ className = "" }: IconProps) => (
  <svg
    ...
    viewBox="0 0 16 16"
    fill="currentColor"
    className={`w-4 h-4 shrink-0 opacity-75 ${className}`}
  >
